  ...
  creditsProfiles: {
    sakura_good_end: {
      ...
      lyrics: [
        ...
        { time: 246, text: [' '] } // 最後の歌詞は表示時間が短くなるので空行で調整
      ],
    },
    kotoha_good_end: {
      ...
      lyrics: [
        { time: 13,  text: ['静寂が落ちる', '夕方の教室', '閉じられたふたに', '指先が迷う'] },
        { time: 27,  text: ['ひと押しの重さ', '記憶が鳴りだす', '笑い声　涙', 'まぶたのうしろ'] },
        { time: 40,  text: ['怖いのは', '音よりも', 'あの日の', 'わたしで'] },
        { time: 55,  text: ['きみと触れる音', 'ほどけていく傷あと', 'まだ震える手のひらに', 'あたたかい影が重なる'] },
        { time: 70,  text: ['きみと触れる音', '少しだけ世界が', 'やわらかい色を取り戻す', 'ここで　また始めてもいいかな (ねえ)'] },
        { time: 100, text: ['誰もいない廊下', '靴音が遠く', '図書室の窓に', '夕陽がひろがる'] },
        { time: 115, text: ['開きかけた譜面', '書き直したはずの', '消えきらない鉛筆の', 'かすかな余白'] },
        { time: 129, text: ['怖いのは', '間違いと', '黙りこむ', '自分で'] },
        { time: 142, text: ['きみと触れる音', 'ひそやかな再生', 'ほどけないと思っていた', '固い結び目がゆるんでく'] },
        { time: 158, text: ['きみと触れる音', '息を合わせるたび', 'あの日とは違う景色で', '同じメロディをなぞってる'] },
        { time: 174, text: ['音が止むたび', '赦されていくようで', '沈黙さえも', 'やさしい手触り'] },
        { time: 188, text: ['「大丈夫」と', '声にしないままで', '隣にいることだけ', '教えてくれる'] },
        { time: 202, text: ['きみと触れる音', '怖さごと抱きしめて', 'ほどよく揺れる不安さえ', '今は進むためのリズム'] },
        { time: 218, text: ['きみと触れる音', '最後まで聴いていて', 'かすれたこの一音から', 'わたしはもう一度　生まれる'] },
        { time: 230, text: ['[ピアノソロ]'] }
      ],
    ...
    mahiru_good_end: {
      ...
      lyrics: [
        { time: 14,  text: ['夕焼け　川沿いの道', '少し冷たい　横顔の影', 'ミラーレスのカメラ　ぶらさげたまま', '今日は　シャッターも　あまり押さないね'] },
        { time: 41,  text: ['ノートには　昨日の続き', '余白ばかりが　増えてゆくページ', '「生きてる理由」なんて　書けなくなっても', '並んだ足音だけは　ちゃんと残ってる'] },
        { time: 67,  text: ['風がページをめくるたび', '言葉がひとつ　こぼれ落ちて', '拾えないまま　笑ってみる', 'それで　いいのかな'] },
        { time: 81,  text: ['理由のない明日へ', 'きみと歩いてゆく', '何も起きない今日が', 'なぜか　少しだけ　愛しくなる'] },
        { time: 95,  text: ['空の色　変わってく', '写真じゃ追いつけない', '「それでも生きていく」を', 'となりで　小さく　確かめてる'] },
        { time: 112, text: ['川面に　ほどける光', '風に揺れてる　ふたりの影', '静けさの中に　まぎれた言い訳', '言わなくても　伝わる気がしてる'] },
        { time: 132, text: ['理由を　数え疲れて', '手帳の端っこ　折りたたむたび', '消えそうな一行　きみの名前だけ', 'どうしてか　消しゴムが　動かないんだ'] },
        { time: 151, text: ['息を合わせて歩くたび', '世界がすこし　柔らかくて', '「大丈夫かな」って　つぶやく声', '風が　持っていく'] },
        { time: 165, text: ['理由のない明日へ', 'きみと歩いてゆく', '何も決めないまま', '同じ景色を　ただ眺めてる'] },
        { time: 179, text: ['空を切る　飛行機雲', '写真に残せなくても', 'ここにあるぬくもりが', '胸のどこかを　そっと埋める'] },
        { time: 193, text: ['言えなかったさよなら', '書けなかったありがとう', 'ノートのすみで　丸めた文字たち', 'きみといる今日だけは', '捨てられずに　抱きしめている'] },
        { time: 220, text: ['理由のない明日へ', 'きみと歩いてゆく', '「意味なんて　なくても」', '風にまぎれて　つぶやいてみる'] },
        { time: 234, text: ['帰り道　伸びてゆく', 'ふたつ分の影法師', 'いつか消えてしまっても', 'たしかに　ここを　歩いていたね'] },
        { time: 249, text: ['最後のページ　閉じる音', '空に溶けてく　かえりみち', '理由は増えなくても', 'きみと並んで　それでも生きていく'] },
        { time: 277, text: [' '] } // 最後の歌詞は表示時間が短くなるので空行で調整
      ],
    },
  },
