...
const VN_CONFIG = {
  ...
  creditsProfiles: {
    sakura_good_end: {
      ...
      lyricTimes: [
        1, 28, 42, 56, 69, 82, 99, 113, 127, 140, 153, 171, 184, 197, 211, 228, 246
      ],
      memoryStills: [
        'sakura_blank_moment',
        'sakura_after_match',
    ...
    kotoha_good_end: {
      ...
      scrollSpeed: 55,
      lyricTimes: [
        13, 27, 40, 55, 70, 100, 115, 129, 142, 158, 174, 188, 202, 218, 230
      ],
      memoryStills: [
        'kotoha_window_ch1',
    ...
    mahiru_good_end: {
      ...
      scrollSpeed: 55,
      lyricTimes: [
        14, 41, 67, 81, 95, 112, 132, 151, 165, 179, 193, 220, 234, 249, 277
      ],
      memoryStills: [
