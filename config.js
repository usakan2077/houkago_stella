    ...
    labels: {
      ja: {
        ...
        settings: {
          ...
          chainDialogue: 'セリフのみ',
          chainAll: 'すべて',
          resetProgress: '進行状況を初期化',
          resetConfirm: 'セーブデータとギャラリーの解放状況をすべて削除します（設定・音量は残ります）。この操作は取り消せません。よろしいですか？',
          resetDone: '進行状況を初期化しました',
        },
      },
      en: {
        titleNewGame: 'NEW  GAME',
        ...
        settings: {
          ...
          resetConfirm: 'This will delete all save data and gallery unlocks (settings and volume are kept). This cannot be undone. Are you sure?',
