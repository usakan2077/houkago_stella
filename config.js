  ...
  creditsProfiles: {
    ...
    mahiru_good_end: {
      ...
      lyrics: [
        ...
        { time: 27,  text: ['ノートには　昨日の続き', '余白ばかりが　増えてゆくページ', '「生きてる理由」なんて　書けなくなっても', '並んだ足音だけは　ちゃんと残ってる'] },
        { time: 53,  text: ['風がページをめくるたび', '言葉がひとつ　こぼれ落ちて', '拾えないまま　笑ってみる', 'それで　いいのかな'] },
        { time: 67,  text: ['理由のない明日へ', 'きみと歩いてゆく', '何も起きない今日が', 'なぜか　少しだけ　愛しくなる'] },
        { time: 81,  text: ['空の色　変わってく', '写真じゃ追いつけない', '「それでも生きていく」を', 'となりで　小さく　確かめてる'] },
        { time: 98,  text: ['川面に　ほどける光', '風に揺れてる　ふたりの影', '静けさの中に　まぎれた言い訳', '言わなくても　伝わる気がしてる'] },
        { time: 118, text: ['理由を　数え疲れて', '手帳の端っこ　折りたたむたび', '消えそうな一行　きみの名前だけ', 'どうしてか　消しゴムが　動かないんだ'] },
        { time: 137, text: ['息を合わせて歩くたび', '世界がすこし　柔らかくて', '「大丈夫かな」って　つぶやく声', '風が　持っていく'] },
        { time: 151, text: ['理由のない明日へ', 'きみと歩いてゆく', '何も決めないまま', '同じ景色を　ただ眺めてる'] },
        { time: 165, text: ['空を切る　飛行機雲', '写真に残せなくても', 'ここにあるぬくもりが', '胸のどこかを　そっと埋める'] },
        { time: 179, text: ['言えなかったさよなら', '書けなかったありがとう', 'ノートのすみで　丸めた文字たち', 'きみといる今日だけは', '捨てられずに　抱きしめている'] },
        { time: 206, text: ['理由のない明日へ', 'きみと歩いてゆく', '「意味なんて　なくても」', '風にまぎれて　つぶやいてみる'] },
        { time: 220, text: ['帰り道　伸びてゆく', 'ふたつ分の影法師', 'いつか消えてしまっても', 'たしかに　ここを　歩いていたね'] },
        { time: 235, text: ['最後のページ　閉じる音', '空に溶けてく　かえりみち', '理由は増えなくても', 'きみと並んで　それでも生きていく'] },
        { time: 263, text: [' '] } // 最後の歌詞は表示時間が短くなるので空行で調整
      ],
    },
  },
